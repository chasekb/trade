...
## Authoritative CI evidence for the replacement closeout

The authoritative prerequisite source SHA `af13535a6931e60eb81a64d6d9800ab6deceec76`
was verified by GitHub Actions run `34165232663`:

```text
Workflow: Docker Build Validation
Run: 34165232663
URL: https://github.com/chasekb/trade/actions/runs/34165232663
Head SHA: af13535a6931e60eb81a64d6d9800ab6deceec76
Status: completed
Conclusion: success
Build Frontend (amd64): success
  https://github.com/chasekb/trade/actions/runs/34165232663/job/101874859708
Build Frontend (arm64): success
  https://github.com/chasekb/trade/actions/runs/34165232663/job/101874859857
Build C++ Backend (amd64): success
  https://github.com/chasekb/trade/actions/runs/34165232663/job/101874859827
Build C++ Backend (arm64): success
  https://github.com/chasekb/trade/actions/runs/34165232663/job/101874859865
Publish Frontend manifest: success
  https://github.com/chasekb/trade/actions/runs/34165232663/job/101875089024
Publish C++ Backend manifest: success
  https://github.com/chasekb/trade/actions/runs/34165232663/job/101922699403
```

All six required build and publication jobs were terminal-successful. This
run is evidence for the exact prerequisite SHA above, not for a later
