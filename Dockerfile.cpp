...
RUN ARCH=$(uname -m) && \
    ...
    ctest --test-dir build --output-on-failure \
      -R "feature_engineer|execution_cohorts|training_validation|transformer_onnx_export|portfolio_accounting|trading_stats_calculator|position_sizing_policy|strategy_signal|strategy_expectancy_harness|execution_reconciliation|coinbase_auth|coinbase_order|coinbase_portfolio"
