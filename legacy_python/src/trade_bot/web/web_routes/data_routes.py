...
def get_app_state_safe():
    """Get app_state safely, raising proper HTTP exception if None."""
...
async def get_loading_status():
    ...
    state = get_app_state_safe()
    check_handlers_ready("data_handlers", state.data_handlers)
    return await state.data_handlers.get_loading_status()
...
async def load_remaining_symbols_async(request: dict):
    ...
    return await state.data_handlers.load_remaining_symbols_async(remaining_symbols, batch_size)
...
async def get_trading_state():
    ...
    state = get_app_state_safe()
    check_handlers_ready("data_handlers", state.data_handlers)
    return await state.data_handlers.get_trading_state()
...
async def save_session_state(request: dict):
    ...
    result = await state.data_handlers.save_session_state(request)
...
async def restore_simulated_trading(request: dict):
    ...
    state = get_app_state_safe()
    check_handlers_ready("data_handlers", state.data_handlers)
    return await state.data_handlers.restore_simulated_trading(request)
...
async def load_session_state(session_id: str):
    ...
    state = get_app_state_safe()
    check_handlers_ready("data_handlers", state.data_handlers)
    return await state.data_handlers.load_session_state(session_id)
...
async def save_dashboard_state(request: dict):
    ...
    state = get_app_state_safe()
    check_handlers_ready("data_handlers", state.data_handlers)
    return await state.data_handlers.save_dashboard_state(request)
...
async def load_dashboard_state(session_id: str):
    ...
    state = get_app_state_safe()
    check_handlers_ready("data_handlers", state.data_handlers)
    return await state.data_handlers.load_dashboard_state(session_id)
...
async def get_trading_metrics():
    ...
    state = get_app_state_safe()
    check_handlers_ready("dashboard_handlers", state.dashboard_handlers)
    return await state.dashboard_handlers.get_trading_metrics()
...
async def get_data_summary():
    ...
    state = get_app_state_safe()
    check_handlers_ready("dashboard_handlers", state.dashboard_handlers)
    return await state.dashboard_handlers.get_data_summary()
...
async def save_session(request: dict):
    ...
    state = get_app_state_safe()
    check_handlers_ready("data_handlers", state.data_handlers)
    return await state.data_handlers.save_session_state(request)
...
async def get_candles(product_id: str, granularity: int, days: int = 7):
    ...
    return await state.dashboard_handlers.get_candles_data(
        product_id,
